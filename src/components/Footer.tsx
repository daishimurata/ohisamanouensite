        ...
        <div className={styles.footerContent}>
          <div className={styles.footerLeft}>
            ...
            <div className={styles.facilityBlock}>
              ...
              <a href="https://maps.google.com/?q=三重県鈴鹿市伊船町2756-1" target="_blank" rel="noopener noreferrer" className={styles.mapButton}>
                地図
              </a>
            </div>
            ...
            <div className={styles.facilityBlock}>
              ...
              <a href="https://maps.google.com/?q=三重県鈴鹿市白子本町15-5" target="_blank" rel="noopener noreferrer" className={styles.mapButton}>
                地図
              </a>
            </div>
          </div>
